  ...
  Widget drawMainCategories() {
    return Column(
      ...
      children: <Widget>[
        ...
        drawCategoryPadding(),
        drawCategory( "Travel Offices" , "2"),
        drawCategoryPadding(),
        drawCategory( "Taxi Services" , "3"),
        drawCategoryPadding(),
        drawCategory( "Home Goods" , "4"),
        drawCategoryPadding(),
        drawCategory( "Clothing & shoes" , "5"),
        drawCategoryPadding(),
        drawCategory( "Driving Schools" , "6"),
        drawCategoryPadding(),
        drawCategory( "Lawyers" , "7"),
        drawCategoryPadding(),
        drawCategory( "Architects" , "8"),
        drawCategoryPadding(),
        drawCategory( "Phones & Accessories" , "9"),
        drawCategoryPadding(),
        drawCategory( "Gym & Fitness" , "10"),
        drawCategoryPadding(),
        drawCategory( "Toys & Gifts" , "11"),
        drawCategoryPadding(),
        drawCategory( "SuperMarkets" , "12"),
        drawCategoryPadding(),
        drawCategory( "Hotles" , "13"),
        drawCategoryPadding(),
        drawCategory( "Hair salon & Beauty center" , "14"),
        drawCategoryPadding(),
        drawCategory( "Medical & Health" , "15"),
        drawCategoryPadding(),
        drawCategory( "Education" , "16"),
        drawCategoryPadding(),
