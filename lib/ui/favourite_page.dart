...
class FaavouritePage extends StatefulWidget {
  final String type;

  FaavouritePage({this.type, Key key}) : super(key: key);

  @override
  _CategoryPageState createState() => _CategoryPageState();
}

class _CategoryPageState extends State<FaavouritePage> {
  ...
  void initState() {
    ...
    super.initState();
    messagesFirebaseRef = FirebaseDatabase().reference().child("favourite").child("${LocalSettings.userId}");
  }
